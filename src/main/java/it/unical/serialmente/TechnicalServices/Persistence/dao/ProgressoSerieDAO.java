...
public interface ProgressoSerieDAO {
    ...
    void avanzaEpisodioEstagione(Integer idUtente, Integer idSerieTV, Integer durataEpisodio, Integer idEpisodioProssimo, Integer idProssimaStagione) throws SQLException;
    boolean creaIstanzaProgressoSerie(Integer idUtente, Integer idTitolo, Integer idEpisodio, Integer idStagione, Integer durataMinuti, Integer numeroProgressivoStagione, Integer numeroProgressivoEpisodio);
