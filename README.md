...
- Track the TV shows and movies you have already watched.  
- Search for new titles using the TMDb catalog.  
- Customize your viewing preferences.  
- Manage your profile, Watchlist, and your Favorite and Watched lists.

Developed as the final project for the **Software Engineering** course (University of Calabria – BSc in Computer Science) by:

### Matteo Mammolti
Responsible for:
- navigation system, menu structure, and view switching  
- TMDb integration (HTTP requests, parsing, processing and displaying results)  
...
- Persistence DAO layer and domain entities


### SNAPSHOTS
<img width="1260" height="709" alt="film" src="https://github.com/user-attachments/assets/346ddfa6-02ed-46b9-9490-fdfacbbf2cf0" />
<img width="1262" height="702" alt="watchlist" src="https://github.com/user-attachments/assets/b3d01740-7054-4409-bac1-901194ecf257" />
<img width="1258" height="707" alt="utente" src="https://github.com/user-attachments/assets/e244b6fe-96a0-4792-8910-304e1b741866" />  
